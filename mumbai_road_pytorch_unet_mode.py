...
edges.to_file("mumbai_roads.geojson", driver='GeoJSON')

print("Saved road network edges to mumbai_roads.geojson")
ox.plot_graph(G)

"""for single raster image"""
...
# # Step 1: Download road network graph
# place_name = "Mumbai, India"
# G = ox.graph.graph_from_place(place_name, network_type='drive')

# # Step 2: Get the edges GeoDataFrame
# edges = ox.graph_to_gdfs(G, nodes=False)

# # Step 3: Define raster size and bbox (from edges bounds)
# img_size = (512, 512)  # e.g. 512x512 pixels
...
# # Step 4: Create blank image mask
# mask = Image.new("L", img_size, 0)
# draw = ImageDraw.Draw(mask)

# # Step 5: Draw roads as lines on mask
...
# # Step 6: Visualize mask
# plt.imshow(np.array(mask), cmap='gray')
# plt.title("Rasterized Road Mask")
# plt.axis('off')
# plt.show()

# # Optional: save mask to disk
# mask.save("mumbai_road_mask.png")
# print("Saved road mask as mumbai_road_mask.png")
...
!zip -r overlay_tiles.zip overlay_tiles/
from google.colab import files
files.download("overlay_tiles.zip")